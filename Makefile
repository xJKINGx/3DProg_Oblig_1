#############################################################################
# Makefile for building: 3D-programmering
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  3Dprog22.pro
# Template: app
# Command: C:\Qt\6.4.2\mingw_64\bin\qmake.exe -o Makefile 3Dprog22.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: 3Dprog22.pro C:/Qt/6.4.2/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.4.2/mingw_64/mkspecs/features/spec_pre.prf \
		...
		C:/Qt/6.4.2/mingw_64/lib/Qt6OpenGL.prl \

...
secondscenehouse::secondscenehouse() {
...
secondscenehouse::secondscenehouse(float scale, QVector3D start) {
    ...
    // BACK
    Vertex v55{m_Position[0] + StartPos[0], m_Position[1] + StartPos[1] + scale*3, m_Position[2] + StartPos[2] + scale*3, RoofColour[0], RoofColour[1], RoofColour[2]};
    Vertex v56{m_Position[0] + StartPos[0] - scale*4, m_Position[1] + StartPos[1] + scale*3, m_Position[2] + StartPos[2] + scale*3, RoofColour[0], RoofColour[1], RoofColour[2]};
    ...
    Vertex v58{m_Position[0] + StartPos[0] - scale*4, m_Position[1] + StartPos[1] + scale*3, m_Position[2] + StartPos[2] + scale*3, RoofColour[0], RoofColour[1], RoofColour[2]};
...
void secondscenehouse::init(GLint matrixUniform) {
